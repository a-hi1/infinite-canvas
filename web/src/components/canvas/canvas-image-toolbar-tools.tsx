...
export type ImageQuickToolId = "info" | "delete" | "saveAsset" | "shareWorkspace" | "download" | "edit" | ImageNodeActionToolId;
...
const defaultBaseToolIds: ImageQuickToolId[] = ["info", "delete", "saveAsset", "shareWorkspace", "download", "edit"];
