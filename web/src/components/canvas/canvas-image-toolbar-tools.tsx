...
export type ImageQuickToolId = "info" | "delete" | "duplicate" | "saveAsset" | "shareWorkspace" | "download" | "edit" | ImageNodeActionToolId;
...
const defaultBaseToolIds: ImageQuickToolId[] = ["info", "delete", "duplicate", "saveAsset", "shareWorkspace", "download", "edit"];
