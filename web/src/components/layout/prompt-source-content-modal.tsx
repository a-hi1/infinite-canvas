    ...
    const load = useCallback(
        async (force: boolean) => {
            ...
            try {
                ...
                setItems(await fetchSourcePrompts(source.id));
            } catch (error) {
                    ...
                    columns={[
                        {
                            ...
                            render: (coverUrl: string) =>
                                coverUrl ? <img src={coverUrl} alt="" className="size-12 rounded object-cover" /> : <div className="size-12 rounded bg-stone-100 dark:bg-stone-800" />,
                        },
                        {
                            title: "标题",
                            dataIndex: "title",
